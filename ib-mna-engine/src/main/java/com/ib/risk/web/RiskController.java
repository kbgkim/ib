...
public class RiskController {
    ...
    public RiskEvaluationResponse evaluate(@RequestBody RiskEvaluationRequest request) {
        ...
        RiskEvaluationResult result = riskCompositeEngine.calculateAndSave(
            request.dealId(),
            request.rawData(),
            request.evaluatorId(),
            request.evalComment()
        ...
        RiskMaster savedMaster = result.master();
        MlPredictResponse mlResponse = result.mlResponse();
        ...
        return new RiskEvaluationResponse(
            ...
            RiskGrade.valueOf(savedMaster.getFinalGrade()),
            RiskGrade.valueOf(savedMaster.getFinalGrade()).getDescription(),
