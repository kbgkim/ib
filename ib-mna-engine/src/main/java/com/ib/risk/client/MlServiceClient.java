...
public class MlServiceClient {
    ...
    public record MlPredictResponse(String dealId, double mlScore, String confidenceLevel, Object featuresUsed) {}
    ...
    public MlPredictResponse predictRiskScore(String dealId) {
        try {
            ...
            return new MlPredictResponse(dealId, 0.0, "ERROR", null);
        }
    }
}
